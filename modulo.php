...
$GLOBALS['__PAGOSMESACTUAL__'] = row_sqlconector("SELECT FORMAT(COALESCE(SUM(INTERES_MENSUAL), 0), 2) AS TOTAL FROM LIBROCONTABLE WHERE TIPO = 'CREDITO' AND MONTH(FECHA) = MONTH(CURDATE()) AND YEAR(FECHA) = YEAR(CURDATE())")['TOTAL'];
