  ...
  if (isset($archivo) && $archivo != "") {
    ...
    if (!((strpos($tipo, "jpeg") || strpos($tipo, "jpg") || strpos($tipo, "webp") || strpos($tipo, "png")) && ($tamano < 500000))) {
    	die ("<br><br>Error. La extensión o el tamaño de los archivos no es correcta.<br>Actualice la Pagina y Intente de Nuevo");
			...
			$imagen="Assets/Perfiles/".readClienteId($_SESSION['user'])['QR_BEP20'];
      ...
      if (move_uploaded_file($temp,$fileImagen)) {
			...
			sqlconector("UPDATE USUARIOS SET QR_BEP20='".$codigorifa.$ext."' WHERE ID=".$_SESSION['user']);						
      }
   	else {
...
<body>
<form id="target" action="subirqrbep20" method="POST" enctype="multipart/form-data" style='text-align: center;'>
<label for="archivo" >
	<img class='img-perfil' style="border: 1px solid black; border-radius:5px;"  width='50' height='50' src='Assets/Perfiles/<?php echo readClienteId($_SESSION['user'])['QR_BEP20']?>' alt=''><br>
</label>
